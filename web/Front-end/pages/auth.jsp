...
<body class="overflow-hidden">
    <div class="flex min-h-screen">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-slate-50 relative">
            <a href="index.html" class="absolute top-8 left-8 flex items-center gap-2 text-slate-400 hover:text-slate-900 transition-all font-bold text-sm uppercase tracking-widest">
            ...
            <div class="w-full max-w-md auth-card">
                ...
                <div id="register-form" class="hidden">
                    <div class="mb-10">
                        ...
                        <p class="text-slate-500 font-medium">Chỉ mất 30 giây để bắt đầu.</p>
                    </div>
