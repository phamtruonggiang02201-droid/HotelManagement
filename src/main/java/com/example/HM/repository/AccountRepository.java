...
public interface AccountRepository extends JpaRepository<Account, String> {
    ...
    Page<Account> findAllByRole_RoleNameInAndIsDeletedFalse(List<String> roleNames, Pageable pageable);
    Page<Account> findAllByIsDeletedFalse(Pageable pageable);

    @Query("SELECT a FROM Account a WHERE a.isDeleted = false AND a.role.roleName IN :roleNames AND (" +
